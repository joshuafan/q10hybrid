...
# pure NN
python experiments/20250502_extrapolate_ta.py --model pure_nn --num_layers 2


# Hybrid only (Reichstein et al)
python experiments/20250502_extrapolate_ta.py --model nn --rb_constraint softplus --num_layers 2

# Our approach
python experiments/20250502_extrapolate_ta.py --model kan --rb_constraint relu --num_layers 1
...
class Objective(object):
    ...
    def __call__(self, trial: optuna.trial.Trial) -> float:
        ...
        lambda_kan_coefdiff = lambda_kan_entropy  # trial.suggest_float('lambda_kan_coefdiff', 1e-3, 1e-1, log=True)
        lambda_kan_coefdiff2 = lambda_kan_entropy  # lambda_kan_coefdiff  # trial.suggest_float('lambda_kan_coefdiff2', 1e-3, 1e-1, log=True)  #, log=True)
    ...
    def add_project_specific_args(parent_parser: ArgumentParser) -> ArgumentParser:
        ...
        parser.add_argument(
            '--log_dir', default='./logs/20250502_extrapolate_ta', type=str)
        return parser
