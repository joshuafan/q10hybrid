...
python experiments/20250430_hyperparam_synth0_hardconstraint.py --model kan --rb_constraint relu --num_layers 1 
...
class Objective(object):
    ...
    def __call__(self, trial: optuna.trial.Trial) -> float:
        ...
        # lambda_out_of_range = trial.suggest_float('lambda_out_of_range', 0.0, 1.0)
    ...
    def add_project_specific_args(parent_parser: ArgumentParser) -> ArgumentParser:
        ...
        parser.add_argument(
            '--log_dir', default='./logs/20250430_synth0_hardconstraint/', type=str)
        return parser
